...
const LandingPage: React.FC = () => {
  ...
  const features = [
    {
      ...
      description: 'محاكي كمي متقدم بتقنية State-Vector يدعم 8+ خوارزميات كمية حقيقية مع تصور كرة بلوخ وخرائط التشابك',
      color: '#8b5cf6',
      stats: '20 كيوبت',
    },
    {
      ...
      description: 'تكامل مع نماذج LLM المتقدمة (Llama 3.3 70B) لتحليل البيانات والتنبؤات الذكية والإجابة على الاستفسارات',
      color: '#3b82f6',
      stats: '96.8% دقة',
    },
    {
      ...
      description: 'تشفير مقاوم للحوسبة الكمية باستخدام Kyber-1024 و CRYSTALS-Dilithium و SPHINCS+ لحماية بياناتك',
      color: '#10b981',
      stats: '99.9% حماية',
    },
    {
      ...
      description: 'محرك تحليلات متقدم مع كشف الشذوذات والتنبؤات والرسوم البيانية الحية مع أكثر من 200 نقطة بيانات',
      color: '#f59e0b',
      stats: '< 2ms استجابة',
    },
    {
      ...
      description: 'بنية تحتية موزعة مع 8 عقد متخصصة تشمل معالجات كمية ومجموعات AI وعقد أمان وبوابات',
      color: '#ec4899',
      stats: '8 عقد',
    },
    {
      ...
      description: 'واجهة برمجية RESTful شاملة مع مصادقة JWT ومعدل تحديد متعدد المستويات ودعم WebSocket',
      color: '#06b6d4',
      stats: 'REST + WS',
    },
  ];
  ...
  const testimonials = [
    { name: 'د. أحمد النعيمي', role: 'CTO - Quantum Dynamics Inc.', text: 'النظام الكمي الأكثر تقدماً الذي رأيته. سهل التكامل مع بنيتنا التحتية.', rating: 5 },
    { name: 'Sarah Mitchell', role: 'VP Engineering - TechVault', text: 'Quantum security features are exceptional. Post-quantum cryptography out of the box.', rating: 5 },
    { name: 'م. فاطمة الزهراء', role: 'Lead Quantum Researcher', text: 'المحاكي الكمي يقدم نتائج دقيقة ومقاربة جداً للواقع. أداة بحثية ممتازة.', rating: 5 },
  ];

  const partners = [
    'Quantum Research Lab', 'AI Solutions Corp', 'CyberShield Pro',
    'DataFlow Systems', 'NeuralTech', 'SecureGrid Networks',
  ];
        ...
        <nav className="absolute top-0 left-0 right-0 z-50 px-6 py-4">
          <div className="max-w-7xl mx-auto flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm text-gray-300">
              ...
              <a href="#stats" className="hover:text-white transition-colors">الإحصائيات</a>
              <a href="#testimonials" className="hover:text-white transition-colors">الآراء</a>
              <button onClick={() => navigate('/pricing')} className="hover:text-white transition-colors">الأسعار</button>
            </div>
            <div className="flex items-center gap-3">
              <button
            ...
            <div>
              ...
              >
                ...
                <p className="text-lg text-gray-400 leading-relaxed mb-8 max-w-lg">
                  دمج الحوسبة الكمية مع الذكاء الاصطناعي وأمان ما بعد الكم في منصة واحدة متكاملة. صُمم لتلبية احتياجات المؤسسات الكبرى.
                </p>
                ...
                <div className="flex items-center gap-6 mt-8 text-sm text-gray-400">
                  <div className="flex items-center gap-1"><CheckCircle className="w-4 h-4 text-green-400" /> بدون بطاقة ائتمان</div>
                  <div className="flex items-center gap-1"><CheckCircle className="w-4 h-4 text-green-400" /> 14 يوم تجربة</div>
                  <div className="flex items-center gap-1"><CheckCircle className="w-4 h-4 text-green-400" /> إلغاء أي وقت</div>
                </div>
              </motion.div>
            </div>
                ...
                <div className="relative bg-gray-900/80 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-6 shadow-2xl">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-gray-800/50 rounded-lg p-3">
                      <div className="flex items-center gap-2 mb-2"><Atom className="w-4 h-4 text-purple-400" /><span className="text-xs text-gray-400">كيوبتات نشطة</span></div>
                      <div className="text-xl font-bold text-purple-300">127</div>
                    </div>
                    <div className="bg-gray-800/50 rounded-lg p-3">
                      <div className="flex items-center gap-2 mb-2"><Shield className="w-4 h-4 text-green-400" /><span className="text-xs text-gray-400">تهديدات محجوبة</span></div>
      ...
      <section id="stats" className="py-20 bg-gray-900/50 border-y border-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: 127, suffix: '+', label: 'كيوبت مدعوم', icon: <Atom className="w-6 h-6 text-purple-400" /> },
              { value: 99, suffix: '.9%', label: 'وقت التشغيل', icon: <TrendingUp className="w-6 h-6 text-green-400" /> },
              { value: 500, suffix: '+', label: 'شركة مستفيدة', icon: <Building2 className="w-6 h-6 text-blue-400" /> },
              { value: 50, suffix: 'M+', label: 'عملية كمية/شهر', icon: <Zap className="w-6 h-6 text-yellow-400" /> },
            ].map((stat, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="text-4xl font-bold mb-4">
              لماذا <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Top1 Quantum AI</span>؟
            </h2>
            ...
            {features.map((feature, i) => (
              <motion.div
                ...
                className={`group relative bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border transition-all duration-300 cursor-pointer ${
                  activeFeature === i ? 'border-gray-500 shadow-lg' : 'border-gray-800 hover:border-gray-700'
                }`}
      ...
      <section className="py-24 bg-gray-900/30">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: <Building2 className="w-8 h-8" />, title: 'البنوك والتمويل', desc: 'تشفير كمي للمعاملات المالية وتحليل المخاطر بالذكاء الاصطناعي', color: '#3b82f6' },
              { icon: <Lock className="w-8 h-8" />, title: 'الدفاع والأمن', desc: 'حماية البيانات الحساسة بتشفير ما بعد الكم مع كشف التهديدات', color: '#10b981' },
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {partners.map((partner, i) => (
              <div key={i} className="flex items-center gap-2 text-gray-500 hover:text-gray-300 transition-colors">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              جاهز للبدء مع
              <br />
              <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">الحوسبة الكمية</span>؟
            </h2>
