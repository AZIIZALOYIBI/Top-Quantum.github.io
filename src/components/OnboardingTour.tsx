  ...
  const steps = [
    {
      ...
      description: 'منصة الحوسبة الكمية والذكاء الاصطناعي الأكثر تقدماً. دعنا نأخذك في جولة سريعة لاستكشاف الميزات.',
      color: '#8b5cf6',
    ...
    },
    {
      ...
      description: 'محاكي كمي حقيقي بتقنية State-Vector يدعم حتى 20 كيوبت. بوابات H, X, Y, Z, CNOT وأكثر مع 8 خوارزميات جاهزة.',
      color: '#8b5cf6',
    ...
    },
    {
      ...
      description: 'تحليلات ذكية مدعومة بنموذج Llama 3.3 70B. اسأل أي سؤال وحصل على تحليل فوري لبياناتك.',
      color: '#3b82f6',
    ...
    },
    {
      ...
      description: 'حماية بيانات من الدرجة العسكرية باستخدام تشفير مقاوم للحوسبة الكمية مع مراقبة التهديدات في الوقت الحقيقي.',
      color: '#10b981',
    ...
    <div className="fixed inset-0 z-[100] bg-gray-950/95 backdrop-blur-xl flex items-center justify-center p-4">
      ...
      >
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {/* Icon */}
            <div className={`inline-flex p-6 rounded-3xl bg-gradient-to-br ${step.gradient} mb-6 shadow-2xl`}
            ...
            <p className="text-gray-400 leading-relaxed mb-8 max-w-lg mx-auto">{step.description}</p>
            ...
            <div className="flex items-center justify-between">
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm transition-all ${
                  isFirst ? 'text-gray-600 cursor-not-allowed' : 'text-gray-400 hover:text-white hover:bg-gray-800'
                }`}
                disabled={isFirst}
              >
        ...
        <div className="text-center mt-4">
          <button onClick={onComplete} className="text-sm text-gray-500 hover:text-gray-300 transition-colors">
            تخطي الجولة
          </button>
        </div>
      </motion.div>
