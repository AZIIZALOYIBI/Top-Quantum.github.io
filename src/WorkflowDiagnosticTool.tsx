...
const WorkflowDiagnosticTool = () => {
  ...
  const [agents, setAgents] = useState([
    ...
    { id: 'answersmall', name: 'AnswerQuestionSmallCsv', status: 'terminated', health: 0, artifacts: 0 },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gray-800/50 backdrop-blur rounded-lg p-6 border border-gray-700">
            ...
            <div className="text-lg font-mono">{quantumMetrics.planckConstant.toExponential(3)}</div>
        ...
        <div className="bg-gray-800/50 backdrop-blur rounded-lg p-6 border border-gray-700 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-400">{analysis.systemHealth.toFixed(1)}%</div>
            ...
            <div className="text-center">
              ...
              >
                <RotateCcw className={`w-4 h-4 ${systemState === 'rebooting' ? 'animate-spin' : ''}`} />
                إعادة تشغيل كمي
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {agents.map((agent) => (
            <div key={agent.id} className="bg-gray-800/50 backdrop-blur rounded-lg p-4 border border-gray-700 hover:border-gray-600 transition-all duration-200">
        ...
        <div className="mt-8 bg-gray-800/50 backdrop-blur rounded-lg p-6 border border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-2">
                العلاقة بين عدم اليقين في الموضع والزخم
              </p>
            </div>
          </div>
